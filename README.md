...
<div align="center">
  <img src="screenshots/屏幕截图 2025-04-02 145348.png" alt="Excel比对工具主界面" width="85%" style="border: 1px solid #ddd; border-radius: 8px; padding: 5px; background: white; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  <p><strong>Excel比对工具主界面</strong> - 提供文件选择、比对设置和结果展示</p>
</div>

<div align="center">
  <img src="screenshots/屏幕截图 2025-04-02 145306.png" alt="Excel比对工具提取列管理" width="85%" style="border: 1px solid #ddd; border-radius: 8px; padding: 5px; background: white; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  <p><strong>提取列管理界面</strong> - 灵活配置提取列，支持多名称识别</p>
</div>

<div align="center">
  <img src="screenshots/屏幕截图 2025-04-02 145249.png" alt="Excel比对工具对比规则管理" width="85%" style="border: 1px solid #ddd; border-radius: 8px; padding: 5px; background: white; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  <p><strong>比对规则管理界面</strong> - 自定义比对规则，支持多条件逻辑组合</p>
</div>
